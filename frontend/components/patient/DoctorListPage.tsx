...
import { cities, healthcareCategories, specializations } from '@/lib/constants';
                                ...
                                doctors.map((doctor) => (
                                    <Card
                                        ...
                                        className="hover:shadow-xl transition-all duration-300
                                         bg-white border-0 shadow-md h-full"
                                    >
                                        <CardContent className="p-6 flex flex-col h-full">
                                            <div className="p-6 flex flex-col h-full justify-center items-center">
                                                <Avatar className="w-20 h-20 mx-auto mb-3">
                                                    ...
                                                    />
                                                    <AvatarFallback
                                                        className="bg-gradient-to-br from-blue-100 to-blue-200 text-blue-700 text-xl font-bold"
                                                    >
